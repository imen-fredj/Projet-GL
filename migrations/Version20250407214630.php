 ...
 */
final class Version20250407214630 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, recepteur_id INT DEFAULT NULL, text VARCHAR(255) NOT NULL, is_read INT NOT NULL, date_notification DATE NOT NULL, INDEX IDX_BF5476CA3B49782D (recepteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
