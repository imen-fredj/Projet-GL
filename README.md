...
Cette branche  l'application du principe **Open/Closed** (OCP) de SOLID pour la gestion des types (congés, documents, modifications) dans une application Symfony.
